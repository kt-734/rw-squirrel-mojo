...
def sqrrl__hire(mut sqrrl__world: sqrrl__Squirrel, title: String, sqrrl__dept: EntityHandle[sqrrl__DepartmentTableState]) -> EntityHandle[sqrrl__EmployeeTableState]:
    var sqrrl__e = sqrrl__world.Employee.create(title = title, dept = sqrrl__dept);
    return sqrrl__e;

def sqrrl__make_person(mut sqrrl__world: sqrrl__Squirrel, name: String, sqrrl__job: EntityHandle[sqrrl__EmployeeTableState]) -> EntityHandle[sqrrl__PersonTableState]:
...
def sqrrl__make_team(mut sqrrl__world: sqrrl__Squirrel, names: List[String], sqrrl__job: EntityHandle[sqrrl__EmployeeTableState]) -> List[EntityHandle[sqrrl__PersonTableState]]:
