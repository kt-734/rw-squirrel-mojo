...
def sqrrl__hire(mut sqrrl__world: sqrrl__World, name: String, email: String, title: String, years_employed: UInt32, salary: Float64, sqrrl__dept: EntityHandle[sqrrl__DepartmentTableState]) raises -> EntityHandle[sqrrl__EmployeeTableState]:
    var profile = Profile(
    ...
    var sqrrl__e = sqrrl__world.Employee.create(email = email, title = title, years_employed = years_employed, salary = salary, dept = sqrrl__dept, profile = profile)
    return sqrrl__e

def sqrrl__hire_team(mut sqrrl__world: sqrrl__World, names: List[String], email_suffix: String, starting_years: UInt32, starting_salary: Float64, sqrrl__dept: EntityHandle[sqrrl__DepartmentTableState]) raises -> List[EntityHandle[sqrrl__EmployeeTableState]]:
