...
from friends import sqrrl__PersonTableState, sqrrl__PersonTable
from friends import sqrrl__GroupTableState, sqrrl__GroupTable
...
def sqrrl__to_json[T: AnyType](value: T) -> String:
    ...
    elif T == Set[EntityHandle[sqrrl__PersonTableState]]:
        return set_to_json(rebind[Set[EntityHandle[sqrrl__PersonTableState]]](value).copy())
